...
expName = 'SOLO_FINAL'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\ADMIN\\OneDrive\\Dokumen\\PsychoPy experiments\\SOLO PROJECT\\SOLO_FINAL_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('prime_words_solo.xlsx'), 
        seed=None, 
        isTrials=True, 
    )
    ...
    trials_2 = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('test_words_solo.xlsx'), 
        seed=None, 
        isTrials=True, 
    )
