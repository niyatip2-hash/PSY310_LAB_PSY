...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\ADMIN\\OneDrive\\Dokumen\\PsychoPy experiments\\Intentional Binding Task\\Intentional Binding Task_lastrun.py',
